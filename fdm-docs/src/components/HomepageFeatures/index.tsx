...
const FeatureList: FeatureItem[] = [
  {
    ...
    description: (
      <>
        Designed to store data of all kinds of farms
      </>
    ),
  },
  {
    ...
    description: (
      <>
        Thanks to PGLite FDM is available to be run locally in the browser. Of course using a PostgreSQL server is also possible.
      </>
    ),
  },
  {
