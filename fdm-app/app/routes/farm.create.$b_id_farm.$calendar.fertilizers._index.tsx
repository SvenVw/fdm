...
/**
 * Loads data for a farm and redirects to the fertilizer application page of its first cultivation.
 *
 ...
 *
 * @returns A redirect response to the fertilizer application page based on the first cultivation's catalogue.
 *
...
export async function loader({ request, params }: LoaderFunctionArgs) {
    try {
        ...
        return redirect(`./${cultivationPlan[0].b_lu_catalogue}`)
    } catch (error) {
