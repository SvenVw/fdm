...
export async function loader({ request, params }: LoaderFunctionArgs) {
    ...
    const layerOptions = [{ layerKey: "fields", layerName: "Percelen" }, {layerKey: "soil", layerName: "Bodem"}]
    ...
    return (
        <SidebarInset>
            <FarmHeader
                ...
                layerSelected={loaderData.layerSelected}
                action={{
            ...
            <main>
                <FarmTitle
                    title={"Kaarten"}
                    description={"Bekijk verschillende kaartlagen van je bedrijf"}
                />
                <ClientOnly
