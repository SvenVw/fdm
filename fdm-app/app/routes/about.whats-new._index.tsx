...
export const changelogEntries: ChangelogEntry[] = [
    {
        ...
        description:
            `Deze update bereidt ${clientConfig.name} voor op 2026 met de voorlopige gebruiksnormen en voegt de AHN4 hoogtekaart toe in de Atlas. De stikstofbalans biedt nu diepgaand inzicht met interactieve grafieken en details per mestgift.`,
        items: [
