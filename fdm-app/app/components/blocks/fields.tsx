            ...
            <PopoverContent className="w-[342px] p-0">
                <Command>
                    ...
                    <CommandList>
                        ...
                        <CommandGroup>
                            {cultivationOptions.map(
                                (cultivation: CultivationOption) => (
                                    <CommandItem
...
function Field(props: fieldType) {
    ...
    const defaultCultivationLabel = props.cultivationOptions.find(
        (option) => option.value === defaultCultivationValue,
    )?.label
    return (
                    ...
                    onSubmit={(e) => {
                        ...
                        if (!form.b_lu.value || !form.b_soiltype_agr.value) {
                            ...
                            toast({
                                title: "Fout",
                                description:
                                    "Hoofdgewas en bodemtype zijn verplicht",
                                variant: "destructive",
                            })
                            return
                        }
                            ...
                            <div className="grid w-full items-center gap-3">
                                ...
                                <div className="flex flex-col space-y-1.5">
                                    ...
                                    <Input
                                        id="b_name"
                                        name="b_name"
                                        placeholder="Bv. Achter de schuur"
                                        defaultValue={props.b_name}
                                    />
                                </div>
                                <div className="flex flex-col space-y-1.5">
                                    ...
                                    <CultivationCombobox
                                        ...
                                        cultivationOptions={
                                            props.cultivationOptions
                                        }
                                        defaultValue={defaultCultivationLabel}
                                    />
                                </div>
                                <div className="flex flex-col space-y-1.5">
                                    <Label htmlFor="b_soiltype_agr">
                                        Bodemtype
                                    </Label>
                                    <Select
                                        name="b_soiltype_agr"
