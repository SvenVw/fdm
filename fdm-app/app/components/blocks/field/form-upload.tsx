...
import { ShapefileUploadAnimation } from "./upload-animation";
            ...
            <CardHeader className="space-y-6">
                ...
                <Alert>
                    ...
                    <AlertDescription className="text-muted-foreground">
                        Deze functie is nog in ontwikkeling. Laat ons het weten als je
                        feedback hebt!
                    </AlertDescription>
                </Alert>
                <CardDescription>
                    Selecteer de bestanden van uw RVO Mijn Percelen export. Zorg ervoor
                    dat u alle bijbehorende bestanden selecteert (.shp, .shx, .dbf,
                    .prj).
                </CardDescription>
            </CardHeader>
    ...
    return (
        <div className="flex justify-center">
            {uploadState === "animating" ? (
                <ShapefileUploadAnimation fieldNames={fieldNames}>
                    {disabledForm}
                </ShapefileUploadAnimation>
            ) : (
                <Card className="w-full max-w-lg mx-auto">
                    <CardHeader className="space-y-6">
                        <CardTitle>Shapefile uploaden</CardTitle>
                                    ...
                                    <div className="space-y-6">
                                        <div className="grid grid-cols-1 gap-4">
                                            ...
                                            <Button
                                                type="submit"
                                                className="w-full"
                                                disabled={isSubmitting || !hasAllRequiredFiles}
                                            >
                                                {isSubmitting ? (
