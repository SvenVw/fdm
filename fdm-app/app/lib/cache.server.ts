...
export function addSecurityHeaders(headers: Headers): Headers {
    ...
    headers.set(
        ...
        img-src 'self' data: blob: https://*.mapbox.com https://*.public.blob.vercel-storage.com https://images.unsplash.com https://lh3.googleusercontent.com https://graph.microsoft.com;
