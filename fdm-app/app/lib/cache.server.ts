...
export function addSecurityHeaders(headers: Headers): Headers {
    ...
    let csp = `default-src 'self';
        ...
        connect-src 'self' https://server.arcgisonline.com https://api.maptiler.com https://sentry.io https://*.sentry.io https://*.nmi-agro.nl https://storage.googleapis.com/fdm-public-data/ https://*.posthog.com ws://localhost:* http://localhost:*;
        frame-src 'self';
