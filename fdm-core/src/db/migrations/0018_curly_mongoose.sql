CREATE TYPE "fdm"."b_lu_harvestcat" AS ENUM('HC010', 'HC020', 'HC031', 'HC040', 'HC041', 'HC042', 'HC050');--> statement-breakpoint
...
ALTER TABLE "fdm"."harvestable_analyses" ADD COLUMN "b_lu_cp" numeric;