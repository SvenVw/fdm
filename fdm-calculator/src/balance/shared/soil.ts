...
export function combineSoilAnalyses<T extends SoilAnalysisPicked>(
    ...
    if (estimateMissing) {
        ...
        if ("a_c_of" in soilAnalysis && soilAnalysis.a_c_of == null && "a_som_loi" in soilAnalysis) {
            (soilAnalysis as any).a_c_of = calculateOrganicCarbon((soilAnalysis as any).a_som_loi)
        }

        if ("a_som_loi" in soilAnalysis && soilAnalysis.a_som_loi == null && "a_c_of" in soilAnalysis) {
            (soilAnalysis as any).a_som_loi = calculateOrganicMatter((soilAnalysis as any).a_c_of)
        }

        if ("a_cn_fr" in soilAnalysis && soilAnalysis.a_cn_fr == null && "a_c_of" in soilAnalysis && "a_n_rt" in soilAnalysis) {
        ...
        if ("a_density_sa" in soilAnalysis && soilAnalysis.a_density_sa == null && "a_som_loi" in soilAnalysis && "b_soiltype_agr" in soilAnalysis) {
